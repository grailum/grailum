...
###   grailumlab.com and grailumlab.com and compares them.
...
RCSUBDIR="test"
HOST1="https://grailumlab.com"
HOST2="https://grailumlab.com"
BASEDIR="/bin/"
...
if [ $? -ne 0 ]; then
   echo "grailum.org failed to provide signature file, but grailumlab.com did?"
   echo "wget output:"
   echo "$WGETOUT"|sed 's/^/\t/g'
...
if [ "$SIGFILEDIFFS" != "" ]; then
   echo "grailum.org and grailumlab.com signature files were not equal?"
